...
export default function SignUp() {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <form className='w-[90%] h-[600px] max-w-[500px] bg-black/20 shadow-black backdrop-blur flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
        
        <h1 className='text-white text-[30px] font-semibold md-[30px]'>
        ...
        <button className='min-w-[150px] h-[60px] text-black font-semibold bg-white rounded-full text-[20px] mt-8'
          disabled={ loading}>
        ...
        <p className='text-white text-[20px] cursor-pointer'>
          ...
          <span className='text-blue-400 px-[5px]' onClick={() => navigate("/signin")}>
            Sign In
          </span>
        </p>
      </form>
